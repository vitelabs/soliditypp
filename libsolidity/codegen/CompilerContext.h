...
public:
	...
	evmasm::AssemblyItem newTag(std::string const& _description = "") { return m_asm->newTag(_description); }
	...
	void appendDebugInfo(std::string const& _debugInfo) { debug("  // " + _debugInfo); m_asm->appendDebugInfo(_debugInfo); }
