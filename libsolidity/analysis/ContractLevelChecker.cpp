...
void ContractLevelChecker::checkDuplicateFunctions(ContractDefinition const& _contract)
{
	...
	/// Solidity++: An onchain function and an offchain function is allowed to have the same signature
	map<string, vector<FunctionDefinition const*>> functions;
//    map<string, vector<FunctionDefinition const*>> offchainFunctions;  // Solidity++
...
//        else if (function->isOffchain())  // Solidity++
//        {
//            solAssert(!function->name().empty(), "");
//            offchainFunctions[function->name()].push_back(function);
//        }
		else
		{
			solAssert(!function->name().empty(), "");
...
//    findDuplicateDefinitions(offchainFunctions);  // Solidity++
}
