...
bool TypeChecker::visit(FunctionDefinition const& _function)
{
	...
	else if (m_currentContract->isInterface())
	{
		...
		else if (_function.visibility() != Visibility::External && _function.visibility() != Visibility::Offchain)
			m_errorReporter.typeError(1560_error, _function.location(), "Functions in interfaces must be declared external or offchain.");
	}
