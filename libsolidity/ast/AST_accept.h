...
// Solidity++:
void MessageDefinition::accept(ASTVisitor& _visitor)
{
	if (_visitor.visit(*this))
	{
		if (m_documentation)
...
// Solidity++:
void MessageDefinition::accept(ASTConstVisitor& _visitor) const
{
	if (_visitor.visit(*this))
	{
		if (m_documentation)
...
// Solidity++:
void SendStatement::accept(ASTVisitor& _visitor)
{
	if (_visitor.visit(*this))
	{
