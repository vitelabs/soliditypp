...
public:
	...
	// Solidity++: size of vite address is 168-bits
...
/**
 * Solidity++:
 * Type for Vite token id.
 */
class ViteTokenIdType: public Type
{
public:
	Category category() const override { return Category::ViteTokenId; }
	// Solidity++: size of vite token id is 80-bits
	unsigned calldataEncodedSize(bool _padded = true) const override { return _padded ? 32 : 80 / 8; }
	unsigned storageBytes() const override { return 80 / 8; }
