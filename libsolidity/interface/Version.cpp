...
// Solidity++: @todo: use cmake to generate build info

char const* solidity::frontend::SolidityppVersionNumber = "0.8.0";

string const solidity::frontend::SolidityppVersionString =
        string(solidity::frontend::VersionNumber);

string const solidity::frontend::SolidityppVersionStringStrict =
        string(solidity::frontend::VersionNumber);

solidity::bytes const solidity::frontend::SolidityppVersionCompactBytes = {
        0,
        8,
        0
};

bool const solidity::frontend::SolidityppVersionIsRelease = false;
