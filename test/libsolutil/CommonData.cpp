...
BOOST_AUTO_TEST_CASE(test_eth_address_get_checksum)
{
	BOOST_CHECK_EQUAL(getChecksummedAddress("0xf977814e90da44bfa03b6295a0616a897441acec"), "0xF977814e90dA44bFA03b6295A0616a897441aceC");
	BOOST_CHECK_EQUAL(getChecksummedAddress("0xF977814e90dA44bFA03b6295A0616a897441aceC"), "0xF977814e90dA44bFA03b6295A0616a897441aceC");
}

BOOST_AUTO_TEST_CASE(test_eth_address_pass_checksum)
{
	BOOST_CHECK(passesAddressChecksum("0xF977814e90dA44bFA03b6295A0616a897441aceC", true));
	BOOST_CHECK(!passesAddressChecksum("0xf977814e90da44bfa03b6295a0616a897441acec", true));
	// no strict
	BOOST_CHECK(passesAddressChecksum("0xf977814e90da44bfa03b6295a0616a897441acec", false));
	// without 0x
	BOOST_CHECK(passesAddressChecksum("F977814e90dA44bFA03b6295A0616a897441aceC", true));
}

BOOST_AUTO_TEST_CASE(test_vite_address_pass_checksum)
{
	BOOST_CHECK(passesViteAddressChecksum("vite_010203040506070809080706050403020102030412227c8b71"));
	// user address
	BOOST_CHECK(passesViteAddressChecksum("vite_aa8e76ea53c8f96bccadfc9819ae1da60b5c74a304e538d870"));
	
	// contract address
	BOOST_CHECK(passesViteAddressChecksum("vite_8cf2663cc949442db2d3f78f372621733292d1fb0b846f1651"));
	BOOST_CHECK(passesViteAddressChecksum("vite_8588d741af13504d79154312f9f4838789aa06d3d0e1b4bea1"));

	// invalid checksum
	BOOST_CHECK(!passesViteAddressChecksum("vite_01020304050607080908070605040302010203040000000000"));
}

BOOST_AUTO_TEST_CASE(test_vite_address_hex)
{
	// user address
	BOOST_CHECK_EQUAL(getViteAddressHex("vite_010203040506070809080706050403020102030412227c8b71"), "0x010203040506070809080706050403020102030400");
	
	// contract address
	BOOST_CHECK_EQUAL(getViteAddressHex("vite_8cf2663cc949442db2d3f78f372621733292d1fb0b846f1651"), "0x8cf2663cc949442db2d3f78f372621733292d1fb01");
}

BOOST_AUTO_TEST_CASE(test_vite_tokenid_pass_checksum)
{
	BOOST_CHECK(passesViteTokenIdChecksum("tti_5649544520544f4b454e6e40"));

	// invalid checksum
	BOOST_CHECK(!passesViteTokenIdChecksum("tti_5649544520544f4b454e0000"));
}

BOOST_AUTO_TEST_CASE(test_vite_tokenid_hex)
{
	BOOST_CHECK_EQUAL(getViteTokenIdHex("tti_5649544520544f4b454e6e40"), "0x5649544520544f4b454e");
}
