...
/// @returns true iff @a _str passess the vite address checksum test.
/// Solidity++: check vite address checksum
bool passesViteAddressChecksum(std::string const& _str);

/// @returns true iff @a _str passess the vite token id checksum test.
/// Solidity++: check vite token id checksum
bool passesViteTokenIdChecksum(std::string const& _str);
...
/// @returns the vite address in hex
/// Solidity++: user address: end with 00; contract address: end with 01
std::string getViteAddressHex(std::string const& _addr);

/// @returns the vite token id in hex
/// Solidity++:
std::string getViteTokenIdHex(std::string const& _tokenid);

// Solidity++:
int checksum(std::string const& _data, std::string const& _checksum);
